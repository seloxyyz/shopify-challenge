  ...
  return (
    <div className='flex justify-center items-center h-screen'>
      ...
      <div className='flex flex-col items-center'>
        ...
        <p className='mb-5 text-slate-500'>e.g. "write a poem about dinosaurs in the snow"</p>
        <form>
          ...
          {fetching === true ?
            <button disabled={fetching} type="button" className="mt-2 mb-5 text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 inline-flex items-center">
            ...
            <button type='submit' onClick={() => submit()} className="mt-2 mb-5 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5">Submit</button>
          }
        </form>
        ...
        {promptRes.length > 0 &&
          <div>
            ...
            {promptRes.map((res: any) =>
              <div key={res.id} className="mb-2 p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md">
